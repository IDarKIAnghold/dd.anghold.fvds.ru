            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="100">
                    <div class="row p-0 sticky-top">
                        ...
                        <div class="border-bottom border-secondary p-3 pt-0">
                            <button class="btn btn-block w-100 bg-success text-white p-3">
                                <Link :href="route('orderView')" class="text-white text-decoration-none">Перейти к
                                оформлению</Link>
                            </button>
